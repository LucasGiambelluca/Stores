...
export default function BulkDeleteModal({ isOpen, count, onClose, onConfirm, isDeleting }: BulkDeleteModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-slate-200 ">
        <h3 className="text-xl font-bold mb-2 text-slate-900 ">¿Eliminar {count} tienda(s)?</h3>
        <p className="text-slate-600 mb-6">Esta acción eliminará las tiendas seleccionadas y revocará sus licencias. No se puede deshacer.</p>
